...
Verses feel [verse direction], chorus [chorus job + harmony], bridge [bridge job — usually stripped].
Final chorus [final lift], then [ending direction].
Mix is [mix quality]. Vocal stays [vocal quality]. [Atmosphere words]. [Language/cultural rule if any].
```
